...
/* harmony default export */ const logo = ((/* unused pure expression or super */ null && (Logo)));
...
;// CONCATENATED MODULE: ./src/assets/images/icons/facebook.png
/* harmony default export */ const facebook = ({"src":"/_next/static/media/facebook.d3b05e50.png","height":20,"width":20,"blurDataURL":"data:image/png;base64,"});
;// CONCATENATED MODULE: ./src/assets/images/icons/twitter.png
/* harmony default export */ const twitter = ({"src":"/_next/static/media/twitter.125eed11.png","height":17,"width":20,"blurDataURL":"data:image/png;base64,"});
;// CONCATENATED MODULE: ./src/assets/images/icons/github.png
/* harmony default export */ const github = ({"src":"/_next/static/media/github.320eceec.png","height":21,"width":20,"blurDataURL":"data:image/png;base64,"});
;// CONCATENATED MODULE: ./src/assets/images/icons/dribbble.png
/* harmony default export */ const dribbble = ({"src":"/_next/static/media/dribbble.5275bbb1.png","height":21,"width":20,"blurDataURL":"data:image/png;base64,"});
...
function Footer() {
    ...
    }, "Copyright by ", new Date().getFullYear(), " Data Cover Insurance")), menuItems.map(({ id , title , items  })=>/*#__PURE__*/ (0,external_theme_ui_.jsx)(widget, {
            key: id,
            title: title,
            items: items
        }))))));
...
function SEO({ description ="datacover file storage and sharing description" , author ="HolyAustin Dev" , meta , title ="datacover" ,  }) {
    const metaData = [
        {
            name: `description`,
            content: description
